...
static KENWOOD_RADIOS: &[(&str, RadioModelStatic)] = &[
    ...
    // Older Kenwood radios (4800 baud, compatible with Kenwood protocol)
    // These radios use the same protocol but may not support the ID command
    (
        "005",
        RadioModelStatic {
            manufacturer: "Kenwood",
            model: "TS-850S",
            protocol: Protocol::Kenwood,
            protocol_id: ProtocolIdStatic::KenwoodId("005"),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "TS-950SDX",
            protocol: Protocol::Kenwood,
            protocol_id: ProtocolIdStatic::KenwoodId("006"),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "TS-440S",
            protocol: Protocol::Kenwood,
            protocol_id: ProtocolIdStatic::KenwoodId("007"),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "TS-940S",
            protocol: Protocol::Kenwood,
            protocol_id: ProtocolIdStatic::KenwoodId("008"),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
...
static YAESU_RADIOS: &[(u8, RadioModelStatic)] = &[
    ...
    // Older Yaesu radios (4800 baud, Yaesu binary protocol)
    (
        0x05,
        RadioModelStatic {
            manufacturer: "Yaesu",
            model: "FT-847",
            protocol: Protocol::Yaesu,
            protocol_id: ProtocolIdStatic::YaesuCode(0x05),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_BASIC,
                min_frequency_hz: 100_000,
                max_frequency_hz: 450_000_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "FT-1000MP",
            protocol: Protocol::Yaesu,
            protocol_id: ProtocolIdStatic::YaesuCode(0x10),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "FT-1000D",
            protocol: Protocol::Yaesu,
            protocol_id: ProtocolIdStatic::YaesuCode(0x11),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
    ...
    (
        ...
        RadioModelStatic {
            ...
            model: "FT-990",
            protocol: Protocol::Yaesu,
            protocol_id: ProtocolIdStatic::YaesuCode(0x12),
            capabilities: RadioCapabilitiesStatic {
                modes: MODES_FULL_HF,
                min_frequency_hz: 100_000,
                max_frequency_hz: 30_000_000,
